        ...
        <Card className="w-full bg-card/90 backdrop-blur sm:p-2">
          <CardHeader>
            <div className="mb-2 flex items-center gap-4">
              ...
              <div>
                <CardTitle>Welcome to Reados</CardTitle>
                <CardDescription className="mt-0 max-w-2xl text-pretty text-sm leading-6 sm:text-base">Start your workday with us. Your path to productivity is just a click away.</CardDescription>
              </div>
            </div>
          </CardHeader>
