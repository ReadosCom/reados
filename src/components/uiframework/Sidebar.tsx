...
import { useIsMobile } from '@components/shadcnhooks/use-mobile';
import { Button } from '@components/uiframework/Button';
import { Input } from '@components/uiframework/Input';
import { Separator } from '@components/uiframework/Separator';
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@components/uiframework/Sheet';
import { Skeleton } from '@components/uiframework/Skeleton';
import { Tooltip, TooltipContent, TooltipTrigger } from '@components/uiframework/Tooltip';
...
function SidebarInput({ className, ...props }: React.ComponentProps<typeof Input>) {
  return <Input data-slot="sidebar-input" data-sidebar="input" className={cn('h-8 w-full border-input bg-muted/20 dark:bg-muted/30', className)} {...props} />;
}
...
function SidebarMenu({ className, ...props }: React.ComponentProps<'ul'>) {
  return <ul data-slot="sidebar-menu" data-sidebar="menu" className={cn('flex w-full min-w-0 flex-col gap-px', className)} {...props} />;
}
